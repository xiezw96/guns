...
-- ----------------------------
BEGIN;
INSERT INTO `sys_config` VALUES (1143324237579165697, '验证码开关', 'GUNS_KAPTCHA_OPEN', 'Y', 1106120265689055233, 'DISABLE', '是否开启验证码', '2019-06-24 12:46:43', 1, NULL, NULL);
INSERT INTO `sys_config` VALUES (1143386834613694465, '阿里云短信的keyId', 'GUNS_SMS_ACCESSKEY_ID', 'N', NULL, 'xxxkey', '阿里云短信的密钥key', '2019-06-25 13:13:59', 1, NULL, NULL);
...
INSERT INTO `sys_config` VALUES (1143468689664876546, '管理系统名称', 'GUNS_SYSTEM_NAME', 'N', NULL, 'Guns优化版', '管理系统名称', '2019-06-25 18:39:15', 1, NULL, NULL);
...
INSERT INTO `sys_config` VALUES (1145207130463191041, '顶部导航条是否开启', 'GUNS_DEFAULT_ADVERT', 'Y', 1106120265689055233, 'DISABLE', '顶部Guns广告是否开启', '2019-06-30 13:47:11', 1, NULL, NULL);
...
INSERT INTO `sys_config` VALUES (1192688477819019266, '第三方登录开关', 'GUNS_OAUTH2_OPEN', 'Y', 1106120265689055233, 'DISABLE', '是否开启第三方登录', '2019-11-08 14:21:07', 1, NULL, NULL);
INSERT INTO `sys_config` VALUES (1194461278045351937, '用户操作开关', 'GUNS_USER_OPERATE_OPEN', 'Y', 1106120265689055233, 'DISABLE', '是否允许用户注册和忘记密码', '2019-11-13 11:45:35', 1, NULL, NULL);
COMMIT;
